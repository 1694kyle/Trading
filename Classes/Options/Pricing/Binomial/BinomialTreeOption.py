...
class BinomialTreeOption(StockOption):
    ...
    def _initialize_stock_price_tree_(self):
        ...
        self.STs = [np.array([self.S0])]  # Array of terminal stock prices, ST (anticipated value at certain date)
    ...
    def _initialize_payoffs_tree_(self):
        ...
        return np.maximum(
            0, (self.STs[self.N]-self.K) if self.is_call else (self.K-self.STs[self.N]))
